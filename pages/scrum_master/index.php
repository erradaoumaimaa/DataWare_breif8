...
?>
    <h1>hi Scrum master</h1>
    <div class="container max-w-7xl mx-auto mt-8">
  <div class="mb-4">
    <h1 class="font-serif text-3xl font-bold underline decoration-gray-400"> List of Project</h1>
    <div class="flex justify-end">
      <button class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Add Project</button>
    </div>
  </div>
